...
const nextConfig = {
  ...
  images: {
    ...
    // Blog/landing kapakları SVG (kendi ürettiğimiz, güvenli). Next Image optimizer
    // SVG'yi varsayılan 400 ile bloklar → blog görselleri görünmüyordu. İzin ver +
    // tarayıcıda script çalıştırmayı CSP ile engelle (güvenlik).
