...
export const LANDING_CONTENT: Record<LandingKey, Record<LandingLocale, LandingData>> = {
  'kahve-fali': {
    en: {
      ...
      image: '/img/landing/kahve-fali.svg',
  ...
  'ruya-tabiri': {
    en: {
      ...
      image: '/img/landing/ruya-tabiri.svg',
  ...
  'birth-chart': {
    en: {
      ...
      image: '/img/landing/birth-chart.svg',
  ...
  sinastri: {
    en: {
      ...
      image: '/img/landing/sinastri.svg',
  ...
  yildizname: {
    en: {
      ...
      image: '/img/landing/yildizname.svg',
