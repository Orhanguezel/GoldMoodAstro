  ...
  'yukselen-burc': {
    en: {
      ...
      sections: [
        ...
        { title: 'What if I do not know my birth time?', paragraphs: ['Do not choose noon or another convenient hour just to obtain a result. Since the ascendant moves through a sign in roughly two hours, even a small uncertainty near a sign boundary can change the ascendant and every house cusp.', 'First check the birth record, hospital document or family notes. If no reliable time exists, rectification is the appropriate next step: an astrologer compares documented life events with possible chart times. Rectification narrows a time range; it should not be presented as guaranteed certainty.'] },
      ...
      faq: [
        ...
        { question: 'How accurate should my birth time be?', answer: 'Use the most exact documented time available. The ascendant changes roughly every two hours, and minutes can matter near a sign or house boundary.' },
        { question: 'Can I calculate a rising sign without a known birth time?', answer: 'Not reliably. Check official or family records first; if no trustworthy time exists, consider a rectification study instead of guessing.' },
      ],
      image: '/img/landing/birth-chart.svg',
      authorTitle: 'GoldMoodAstro Editorial Team',
    ...
    tr: {
      ...
      sections: [
        ...
        { title: 'Doğum saatimi bilmiyorsam ne yapmalıyım?', paragraphs: ['Yalnızca sonuç almak için öğlen 12.00 gibi varsayılan bir saat seçmeyin. Yükselen yaklaşık iki saatte bir burç değiştirdiği için, burç sınırına yakın küçük bir saat farkı bile yükseleni ve bütün ev girişlerini değiştirebilir.', 'Önce nüfus kaydı, hastane belgesi veya aile notlarını kontrol edin. Güvenilir saat bulunamazsa rektifikasyon uygun adımdır: astrolog, belgelenmiş yaşam olaylarını olası harita saatleriyle karşılaştırır. Rektifikasyon bir saat aralığını daraltır; garanti kesinlik olarak sunulmamalıdır.'] },
      ...
      faq: [
        ...
        { question: 'Doğum saatim ne kadar hassas olmalı?', answer: 'Bulabildiğiniz en net belgeli saati kullanın. Yükselen yaklaşık iki saatte bir değişir; burç veya ev sınırına yakın doğumlarda dakikalar da sonucu etkileyebilir.' },
        { question: 'Doğum saati olmadan yükselen hesaplanabilir mi?', answer: 'Güvenilir biçimde hayır. Önce resmi ve aile kayıtlarını kontrol edin; güvenilir saat yoksa tahmin yerine rektifikasyon çalışmasını değerlendirin.' },
      ],
      image: '/img/landing/birth-chart.svg',
      authorTitle: 'GoldMoodAstro Editoryal Ekibi',
    ...
    de: {
      ...
      sections: [
        ...
        { title: 'Was tun, wenn die Geburtszeit unbekannt ist?', paragraphs: ['Wähle nicht einfach 12 Uhr oder eine andere bequeme Uhrzeit, nur um ein Ergebnis zu erhalten. Da der Aszendent ungefähr alle zwei Stunden das Zeichen wechselt, kann schon eine kleine Unsicherheit nahe einer Zeichengrenze Aszendent und alle Häuserspitzen verändern.', 'Prüfe zuerst Geburtsurkunde, Krankenhausunterlagen oder Familiennotizen. Gibt es keine verlässliche Zeit, ist eine Rektifikation der passende nächste Schritt: Dokumentierte Lebensereignisse werden mit möglichen Horoskopzeiten verglichen. Eine Rektifikation grenzt die Zeit ein, ist aber keine garantierte Gewissheit.'] },
      ...
      faq: [
        ...
        { question: 'Wie genau sollte meine Geburtszeit sein?', answer: 'Nutze die genaueste dokumentierte Zeit. Der Aszendent wechselt ungefähr alle zwei Stunden; nahe einer Zeichen- oder Häusergrenze können auch Minuten relevant sein.' },
        { question: 'Kann ich den Aszendenten ohne bekannte Geburtszeit berechnen?', answer: 'Nicht verlässlich. Prüfe zuerst offizielle und familiäre Unterlagen; fehlt eine vertrauenswürdige Zeit, ist eine Rektifikation sinnvoller als eine Schätzung.' },
      ],
      image: '/img/landing/birth-chart.svg',
      authorTitle: 'GoldMoodAstro Redaktion',
