...
// 2026-05-16: Canli aktif tema ile hizali Amethyst + Gold palette.
// SSR fetch fail olursa bu varsayılanlar kullanılır.
export const DEFAULT_TOKENS: DesignTokens = {
  version: '2',
  colors: {
    // Brand - live amethyst primary + gold secondary
