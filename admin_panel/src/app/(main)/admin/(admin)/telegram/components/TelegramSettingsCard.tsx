...
export default function TelegramSettingsCard({ settings, setSettings }: Props) {
  ...
  const previewVars = React.useMemo<TemplateVars>(
    () => ({
      ...
      service_title: 'Doğum Haritası Yorumu 60 dk',
      resource_title: 'Danışman: Zeynep Yıldız',
      customer_message: 'Lütfen geri arayın.',
      decision_note: 'Admin tarafından onaylandı.',
      status_before: 'new',
      ...
      message: 'Önümüzdeki hafta için bir randevu almak istiyorum.',
    }),
    [],
  );
