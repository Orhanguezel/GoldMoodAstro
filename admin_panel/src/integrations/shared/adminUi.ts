...
export function normalizeAdminUiCopy(raw: unknown): AdminUiCopy {
  ...
  const items: AdminNavCopy['items'] = {
    ...
    account_deletions: uiText(itemsRaw.account_deletions),
    ...
    invoices: uiText(itemsRaw.invoices),
    ...
    eko_telegram: uiText(itemsRaw.eko_telegram),
