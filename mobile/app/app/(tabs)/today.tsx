...
function buildScreenStyles(t: AppTheme) {
  ...
  gridIcon: { width: 44, height: 44, borderRadius: 22, backgroundColor: colors.surfaceHigh, alignItems: 'center', justifyContent: 'center', borderWidth: 1 },
  ...
  transitIconWrap: { width: 36, height: 36, borderRadius: 18, backgroundColor: colors.gold + '18', alignItems: 'center', justifyContent: 'center' },
  transitBody: { flex: 1 },
  ...
  ctaTextCol: { flex: 1 },
  ctaKicker: { fontFamily: font.sansBold, fontSize: 10, color: colors.ink, letterSpacing: 2, opacity: 0.8 },
  ctaTitle: { fontFamily: font.display, fontSize: 22, color: colors.ink, marginTop: 8, marginBottom: 12 },
  ...
  ctaBadgeText: { fontFamily: font.sansBold, fontSize: 9, color: colors.ink },
            ...
            >
              <View style={styles.ctaContent}>
                ...
                <View style={styles.ctaCircle}>
                  <ArrowRight size={24} color={colors.ink} />
                </View>
              </View>
            </LinearGradient>
          </Pressable>
