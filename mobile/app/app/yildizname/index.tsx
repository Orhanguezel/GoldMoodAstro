...
function buildScreenStyles(t: AppTheme) {
  ...
  mainBtnText: { fontFamily: font.sansBold, fontSize: 16, color: colors.ink, letterSpacing: 1 },
...
function menzilCategories(raw: unknown): string[] {
  if (raw == null) return [];
  ...
  if (typeof raw === 'object' && raw !== null && 'label' in (raw as object)) {
              ...
              <View style={styles.summaryBox}>
                ...
                >
                  ...
                  <View style={styles.categoryContainer}>
                    {menzilCategories(result.menzil?.category).map((cat, i) => (
