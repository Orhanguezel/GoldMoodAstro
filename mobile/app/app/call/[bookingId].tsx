...
function buildScreenStyles(t: AppTheme) {
  ...
  statusText: { fontFamily: font.sansBold, fontSize: 10, color: 'rgba(250,246,239,0.55)', letterSpacing: 1 },
  ...
  remoteVideo: { flex: 1 },
  localPreview: { position: 'absolute', top: 16, right: 16, width: 100, height: 140, borderRadius: radius.md, overflow: 'hidden', borderWidth: 2, borderColor: colors.gold, backgroundColor: colors.inkSoft },
  localVideo: { flex: 1 },
  placeholder: { flex: 1, justifyContent: 'center', alignItems: 'center', gap: 16 },
  placeholderText: { fontFamily: font.sans, fontSize: 13, color: 'rgba(250,246,239,0.55)' },
  ...
  avatarFallback: { width: '100%', height: '100%', borderRadius: 76, backgroundColor: colors.inkSoft, alignItems: 'center', justifyContent: 'center' },
  ...
  audioInfo: { fontFamily: font.sansBold, fontSize: 13, color: 'rgba(250,246,239,0.55)', marginTop: 40, letterSpacing: 2 },
...
export default function CallScreen() {
  ...
  return (
    <View style={styles.container}>
      <LinearGradient colors={[colors.inkDeep, colors.deep]} style={styles.full}>
