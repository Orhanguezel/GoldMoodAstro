/** Frontend `celebrities.ts` ile aynı statik veri — T42-1 ünlüler paritesi */
...
export const SIGN_LABELS: Record<ZodiacSignId, string> = {
  aries: 'Koç',
  taurus: 'Boğa',
  gemini: 'İkizler',
  cancer: 'Yengeç',
...
export function getCelebritiesBySign(sign: ZodiacSignId, limit = 8): CelebrityZodiac[] {
