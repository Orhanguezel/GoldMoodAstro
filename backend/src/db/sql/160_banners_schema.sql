...
('b0000000-0000-4000-8000-000000000001', 'launch_welcome',
 ...
 '/assets/images/banners/welcome-premium-banner-bg.png', '/tr/consultants', 'Danışmanları Keşfet', 'Discover Consultants',
...
('b0000000-0000-4000-8000-000000000010', 'mid_birth_chart',
 ...
 '/assets/images/banners/birth-chart-banner-bg.png', '/tr/birth-chart', 'Haritamı Oluştur', 'Create Chart',
...
('b0000000-0000-4000-8000-000000000011', 'mid_premium',
 ...
 '/assets/images/banners/premium-membership-banner-bg.png', '/tr/pricing', 'Üye Ol', 'Upgrade',
...
('b0000000-0000-4000-8000-000000000012', 'mid_welcome20',
 ...
 '/assets/images/banners/first-session-discount-banner-bg.png', '/tr/pricing?coupon=WELCOME20', 'Kodu Kullan', 'Use Code',
...
('b0000000-0000-4000-8000-000000000013', 'mid_first_session',
 ...
 '/assets/images/banners/first-session-discount-banner-bg.png', '/tr/consultants', 'Hemen Başla', 'Get Started',
...
('b0000000-0000-4000-8000-000000000014', 'mobile_ad_free_premium',
 ...
 '/assets/images/banners/app-download-bg.png', '/tr/pricing', 'Premium''a Geç', 'Go Premium',
...
('b0000000-0000-4000-8000-000000000020', 'upsell_consultant',
 ...
 '/assets/images/banners/welcome-premium-banner-bg.png', '/tr/consultants', 'Bir Uzmanla Görüş', 'Talk to an Expert',
 'consultant_detail_top', '*', 'all', NULL, 40, 1)
