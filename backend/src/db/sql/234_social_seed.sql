...
INSERT IGNORE INTO social_projects
  (uuid, project_key, name, website_url, ga4_measurement_id, ga4_property_id, gtm_container_id, search_console_site_url, is_active)
VALUES
  (UUID(), 'goldmoodastro', 'GoldMoodAstro', 'https://goldmoodastro.com',
   'G-M8FPZB5FFC', '542424498', 'GTM-WDQ822LF', 'sc-domain:goldmoodastro.com', 1);

-- GA4 sayisal property ID (Data API icin). Sistem alani; re-seed'de bos ise doldurulur.
UPDATE social_projects SET ga4_property_id = '542424498'
WHERE project_key = 'goldmoodastro' AND (ga4_property_id IS NULL OR ga4_property_id = '');
