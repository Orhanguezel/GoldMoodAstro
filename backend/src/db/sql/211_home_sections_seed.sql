...
('a1000000-0000-4000-8000-000000000002', 'banner_welcome',        'Karşılama Bannerı (Gözlemevi)',        'BannerSlot',               20,  1, JSON_OBJECT('placement','home_hero','variant','hero','count',1,'dismissable',false)),
...
('a1000000-0000-4000-8000-000000000005', 'banner_birth_chart',    'Doğum Haritası Bannerı (Parşömen)',     'BannerSlot',               50,  1, JSON_OBJECT('placement','home_mid_1','variant','hero','count',1,'dismissable',false)),
...
('a1000000-0000-4000-8000-00000000000c', 'banner_premium',        'Premium Üyelik Bannerı (Lüks Yıldız)', 'BannerSlot',               80,  1, JSON_OBJECT('placement','home_mid_2','variant','hero','count',1,'dismissable',true)),
...
('a1000000-0000-4000-8000-00000000000f', 'banner_discount',       'İndirim Bannerı (Altın Pusula)',       'BannerSlot',               130, 1, JSON_OBJECT('placement','home_mid_3','variant','hero','count',1,'dismissable',true)),
