...
('20000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000001','zeynep-yildiz','20 yıllık astroloji deneyimiyle doğum haritası, yıllık öngörüler ve ilişki analizi konularında uzmanlaşmış kıdemli danışman.','["astrology","birth_chart","relationship"]','["tr","en"]',16.00,30,1,21.50,'EUR','approved',1,4.90,42,126),
('20000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000000002','omer-toprak','Sayıların gizemli dünyasında rehberiniz. Hayat yolu analizi ve isim enerjisi üzerine derinleşen numeroloji ve tarot uzmanı.','["tarot","numerology"]','["tr"]',11.50,30,0,NULL,'EUR','approved',1,4.75,31,88),
('20000000-0000-4000-8000-000000000003','10000000-0000-4000-8000-000000000003','selin-ay','Modern spiritualite ile kadim bilgeliği birleştiren ruhsal rehber. Sezgisel astroloji ve yaşam koçluğu seansları sunmaktadır.','["astrology","mood","career"]','["tr","en"]',20.00,45,1,25.50,'EUR','approved',1,4.85,27,64),
...
('20000000-0000-4000-8000-000000000004','10000000-0000-4000-8000-0000000000b1','murat-kisikcilar','Proje ortağı ve stratejik danışman. Detaylı bio admin panelden eklenecek.','["astrology"]','["tr"]',0.00,30,1,0.00,'EUR','pending',0,0.00,0,0),
('20000000-0000-4000-8000-000000000005','10000000-0000-4000-8000-0000000000b2','pinar-demircioglu','Proje ortağı ve danışman. Detaylı bio admin panelden eklenecek.','["psikoloji","bilincalti_donusum","yasam_koclugu"]','["tr"]',0.00,30,1,0.00,'EUR','pending',0,0.00,0,0),
('20000000-0000-4000-8000-000000000006','10000000-0000-4000-8000-0000000000b3','fatma-guclu','Hayatım boyunca yaşadığım döngüleri ve zorlukları anlamak için bir yol aradım. Bu yolda astroloji bana rehberlik etti. Doğum haritası analizi, ilişki danışmanlığı, horary astroloji ve rektifikasyon hizmetlerinde uzmanım.','["astrology","birth_chart","relationship"]','["tr"]',32.50,45,1,39.50,'EUR','approved',1,4.95,25,0);
