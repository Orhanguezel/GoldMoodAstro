...
('60000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000001','20000000-0000-4000-8000-000000000001',595.00,0.00,595.00,0.00,'EUR','active'),
('60000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000000002','20000000-0000-4000-8000-000000000002',0.00,0.00,0.00,0.00,'EUR','active'),
('60000000-0000-4000-8000-000000000003','10000000-0000-4000-8000-000000000003','20000000-0000-4000-8000-000000000003',0.00,0.00,0.00,0.00,'EUR','active')
...
('61000000-0000-4000-8000-000000000001','60000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000001','credit',350.00,'EUR','booking_payout','Doğum haritası seansı kazancı','admin_manual','completed',1,DATE_SUB(NOW(3), INTERVAL 10 DAY)),
('61000000-0000-4000-8000-000000000002','60000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000001','credit',245.00,'EUR','booking_payout','İlişki analizi seansı kazancı','admin_manual','completed',1,DATE_SUB(NOW(3), INTERVAL 4 DAY))
ON DUPLICATE KEY UPDATE
