...
('01000000-0000-4000-8000-000000000025', 'contact_info',             '*', '{"email":"goldmoodastro@gmail.com","phone":"0212 807 09 59","address":"Büyükçekmece / İstanbul"}'),
('01000000-0000-4000-8000-000000000026', 'company_brand',            '*', '{"name":"GoldMoodAstro","slogan":"Yıldızlarla tanışan modern astroloji","legal_name":"QUEBAB GIDA FABRİKASI RESTORAN İŞLETMECİLİĞİ EĞLENCE ORGANİZASYON VE KİRALAMA TİCARET LTD. ŞTİ.","mersis":"0632143381600001","tax_no":"6321433816","trade_registry":"491688-5","address":"Büyükçekmece / İstanbul","phone":"0212 807 09 59","email":"goldmoodastro@gmail.com"}'),
...
('01000000-0000-4000-8000-0000000000e1', 'mobile_min_version',        '*', '0.1.0'),
('01000000-0000-4000-8000-0000000000e2', 'mobile_latest_version',     '*', '0.1.0'),
('01000000-0000-4000-8000-0000000000e3', 'mobile_update_url',         '*', 'https://goldmoodastro.com'),
('01000000-0000-4000-8000-0000000000e4', 'mobile_payment_success_patterns', '*', '["/siparis/basarili","/booking/success","checkout=success","payment=success","status=success"]'),
('01000000-0000-4000-8000-0000000000e5', 'mobile_payment_failure_patterns', '*', '["/sepet?payment=failed","/sepet?payment=error","checkout=failed","payment=failed","payment=error","status=failure","status=failed"]'),
-- Design tokens (public, consumed by frontend + admin panel + mobile)
...
-- i18n: aktif diller + varsayılan. Admin locale seçicileri (blog/landing/service kategorileri
-- vb.) buna bağlı; BOŞSA useAdminLocales boş döner ve i18n formları kırılır (dropdown + alanlar boş).
-- INSERT IGNORE: admin ayar sayfasından değiştirilirse deploy ezmez.
INSERT IGNORE INTO site_settings (id, `key`, locale, value) VALUES
('01000000-0000-4000-8000-0000000000f1', 'app_locales',    '*', '[{"code":"tr","label":"Türkçe","is_default":true,"is_active":true},{"code":"en","label":"English","is_active":true},{"code":"de","label":"Deutsch","is_active":true}]'),
('01000000-0000-4000-8000-0000000000f2', 'default_locale', '*', 'tr');
