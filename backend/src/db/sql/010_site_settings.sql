...
-- Iyzipay ARTIK KULLANILMIYOR (aktif sağlayıcı Stripe). Satırlar tarihsel.
...
('01000000-0000-4000-8000-000000000031', 'bing_site_verification',   '*', ''),
('01000000-0000-4000-8000-000000000032', 'custom_css',               '*', ''),
('01000000-0000-4000-8000-000000000033', 'public_base_url',          '*', 'https://goldmoodastro.com'),
