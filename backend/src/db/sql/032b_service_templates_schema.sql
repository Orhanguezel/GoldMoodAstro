...
VALUES
  ...
  (CONCAT(SUBSTRING(MD5('astrology|free-intro'),1,8),'-',SUBSTRING(MD5('astrology|free-intro'),9,4),'-4',SUBSTRING(MD5('astrology|free-intro'),14,3),'-8',SUBSTRING(MD5('astrology|free-intro'),18,3),'-',SUBSTRING(MD5('astrology|free-intro'),21,12)),'astrology','Ücretsiz Tanışma Görüşmesi','free-intro','Ücretsiz ön görüşme: ihtiyaç ve beklentilerinizi paylaşmak için kısa tanışma.',15,0.00,'EUR','audio',1,1,1),
  (CONCAT(SUBSTRING(MD5('astrology|dogum-haritasi-yorumu'),1,8),'-',SUBSTRING(MD5('astrology|dogum-haritasi-yorumu'),9,4),'-4',SUBSTRING(MD5('astrology|dogum-haritasi-yorumu'),14,3),'-8',SUBSTRING(MD5('astrology|dogum-haritasi-yorumu'),18,3),'-',SUBSTRING(MD5('astrology|dogum-haritasi-yorumu'),21,12)),'astrology','Doğum Haritası Yorumu','dogum-haritasi-yorumu','Gezegen yerleşimleri ve açılarla kişilik, potansiyel ve güncel etkiler.',60,32.50,'EUR','audio',0,2,1),
  (CONCAT(SUBSTRING(MD5('astrology|hizli-soru'),1,8),'-',SUBSTRING(MD5('astrology|hizli-soru'),9,4),'-4',SUBSTRING(MD5('astrology|hizli-soru'),14,3),'-8',SUBSTRING(MD5('astrology|hizli-soru'),18,3),'-',SUBSTRING(MD5('astrology|hizli-soru'),21,12)),'astrology','Hızlı Soru Seansı','hizli-soru','Tek bir konuya odaklı kısa, öz yorum.',20,7.00,'EUR','audio',0,3,1),

  (CONCAT(SUBSTRING(MD5('birth_chart|free-intro'),1,8),'-',SUBSTRING(MD5('birth_chart|free-intro'),9,4),'-4',SUBSTRING(MD5('birth_chart|free-intro'),14,3),'-8',SUBSTRING(MD5('birth_chart|free-intro'),18,3),'-',SUBSTRING(MD5('birth_chart|free-intro'),21,12)),'birth_chart','Ücretsiz Tanışma Görüşmesi','free-intro','Ücretsiz ön görüşme.',15,0.00,'EUR','audio',1,1,1),
  (CONCAT(SUBSTRING(MD5('birth_chart|detayli-dogum-haritasi'),1,8),'-',SUBSTRING(MD5('birth_chart|detayli-dogum-haritasi'),9,4),'-4',SUBSTRING(MD5('birth_chart|detayli-dogum-haritasi'),14,3),'-8',SUBSTRING(MD5('birth_chart|detayli-dogum-haritasi'),18,3),'-',SUBSTRING(MD5('birth_chart|detayli-dogum-haritasi'),21,12)),'birth_chart','Detaylı Doğum Haritası Analizi','detayli-dogum-haritasi','Tam kapsamlı natal okuma: kişilik, kariyer, ilişki, ruhsal yön, transitler.',90,50.50,'EUR','audio',0,2,1),
  (CONCAT(SUBSTRING(MD5('birth_chart|rektifikasyon'),1,8),'-',SUBSTRING(MD5('birth_chart|rektifikasyon'),9,4),'-4',SUBSTRING(MD5('birth_chart|rektifikasyon'),14,3),'-8',SUBSTRING(MD5('birth_chart|rektifikasyon'),18,3),'-',SUBSTRING(MD5('birth_chart|rektifikasyon'),21,12)),'birth_chart','Rektifikasyon','rektifikasyon','Doğum saati bilinmeyen veya emin olunmayan danışanlar için yaşam olayları üzerinden doğum saati netleştirme çalışması.',60,32.50,'EUR','audio',0,3,1),

  (CONCAT(SUBSTRING(MD5('tarot|free-intro'),1,8),'-',SUBSTRING(MD5('tarot|free-intro'),9,4),'-4',SUBSTRING(MD5('tarot|free-intro'),14,3),'-8',SUBSTRING(MD5('tarot|free-intro'),18,3),'-',SUBSTRING(MD5('tarot|free-intro'),21,12)),'tarot','Ücretsiz Tanışma Görüşmesi','free-intro','Ücretsiz ön görüşme.',15,0.00,'EUR','audio',1,1,1),
  (CONCAT(SUBSTRING(MD5('tarot|tarot-acilimi'),1,8),'-',SUBSTRING(MD5('tarot|tarot-acilimi'),9,4),'-4',SUBSTRING(MD5('tarot|tarot-acilimi'),14,3),'-8',SUBSTRING(MD5('tarot|tarot-acilimi'),18,3),'-',SUBSTRING(MD5('tarot|tarot-acilimi'),21,12)),'tarot','Tarot Açılımı','tarot-acilimi','Kartların sembolizmiyle sorularınıza rehberlik.',30,11.50,'EUR','audio',0,2,1),

  (CONCAT(SUBSTRING(MD5('numerology|free-intro'),1,8),'-',SUBSTRING(MD5('numerology|free-intro'),9,4),'-4',SUBSTRING(MD5('numerology|free-intro'),14,3),'-8',SUBSTRING(MD5('numerology|free-intro'),18,3),'-',SUBSTRING(MD5('numerology|free-intro'),21,12)),'numerology','Ücretsiz Tanışma Görüşmesi','free-intro','Ücretsiz ön görüşme.',15,0.00,'EUR','audio',1,1,1),
  (CONCAT(SUBSTRING(MD5('numerology|numeroloji-raporu'),1,8),'-',SUBSTRING(MD5('numerology|numeroloji-raporu'),9,4),'-4',SUBSTRING(MD5('numerology|numeroloji-raporu'),14,3),'-8',SUBSTRING(MD5('numerology|numeroloji-raporu'),18,3),'-',SUBSTRING(MD5('numerology|numeroloji-raporu'),21,12)),'numerology','Numeroloji Raporu','numeroloji-raporu','İsim ve doğum tarihinden yaşam yolu yorumu.',30,11.50,'EUR','audio',0,2,1),

  (CONCAT(SUBSTRING(MD5('coffee|free-intro'),1,8),'-',SUBSTRING(MD5('coffee|free-intro'),9,4),'-4',SUBSTRING(MD5('coffee|free-intro'),14,3),'-8',SUBSTRING(MD5('coffee|free-intro'),18,3),'-',SUBSTRING(MD5('coffee|free-intro'),21,12)),'coffee','Ücretsiz Tanışma Görüşmesi','free-intro','Ücretsiz ön görüşme.',15,0.00,'EUR','audio',1,1,1),
  (CONCAT(SUBSTRING(MD5('coffee|kahve-fali-yorumu'),1,8),'-',SUBSTRING(MD5('coffee|kahve-fali-yorumu'),9,4),'-4',SUBSTRING(MD5('coffee|kahve-fali-yorumu'),14,3),'-8',SUBSTRING(MD5('coffee|kahve-fali-yorumu'),18,3),'-',SUBSTRING(MD5('coffee|kahve-fali-yorumu'),21,12)),'coffee','Kahve Falı Yorumu','kahve-fali-yorumu','Fincan sembollerinin geleneksel anlamlarıyla kişisel yorum.',20,8.00,'EUR','audio',0,2,1),

  (CONCAT(SUBSTRING(MD5('relationship|free-intro'),1,8),'-',SUBSTRING(MD5('relationship|free-intro'),9,4),'-4',SUBSTRING(MD5('relationship|free-intro'),14,3),'-8',SUBSTRING(MD5('relationship|free-intro'),18,3),'-',SUBSTRING(MD5('relationship|free-intro'),21,12)),'relationship','Ücretsiz Tanışma Görüşmesi','free-intro','Ücretsiz ön görüşme.',15,0.00,'EUR','audio',1,1,1),
  (CONCAT(SUBSTRING(MD5('relationship|iliski-sinastri'),1,8),'-',SUBSTRING(MD5('relationship|iliski-sinastri'),9,4),'-4',SUBSTRING(MD5('relationship|iliski-sinastri'),14,3),'-8',SUBSTRING(MD5('relationship|iliski-sinastri'),18,3),'-',SUBSTRING(MD5('relationship|iliski-sinastri'),21,12)),'relationship','İlişki & Sinastri Analizi','iliski-sinastri','İki haritanın karşılaştırılması; ilişki dinamikleri ve uyum.',60,39.50,'EUR','audio',0,2,1),

  (CONCAT(SUBSTRING(MD5('mood|free-intro'),1,8),'-',SUBSTRING(MD5('mood|free-intro'),9,4),'-4',SUBSTRING(MD5('mood|free-intro'),14,3),'-8',SUBSTRING(MD5('mood|free-intro'),18,3),'-',SUBSTRING(MD5('mood|free-intro'),21,12)),'mood','Ücretsiz Tanışma Görüşmesi','free-intro','Ücretsiz ön görüşme.',15,0.00,'EUR','audio',1,1,1),
  (CONCAT(SUBSTRING(MD5('mood|ruhsal-rehberlik'),1,8),'-',SUBSTRING(MD5('mood|ruhsal-rehberlik'),9,4),'-4',SUBSTRING(MD5('mood|ruhsal-rehberlik'),14,3),'-8',SUBSTRING(MD5('mood|ruhsal-rehberlik'),18,3),'-',SUBSTRING(MD5('mood|ruhsal-rehberlik'),21,12)),'mood','Ruhsal Rehberlik Seansı','ruhsal-rehberlik','İçsel denge ve farkındalık için destekleyici seans.',45,20.00,'EUR','audio',0,2,1),

  (CONCAT(SUBSTRING(MD5('career|free-intro'),1,8),'-',SUBSTRING(MD5('career|free-intro'),9,4),'-4',SUBSTRING(MD5('career|free-intro'),14,3),'-8',SUBSTRING(MD5('career|free-intro'),18,3),'-',SUBSTRING(MD5('career|free-intro'),21,12)),'career','Ücretsiz Tanışma Görüşmesi','free-intro','Ücretsiz ön görüşme.',15,0.00,'EUR','audio',1,1,1),
  (CONCAT(SUBSTRING(MD5('career|kariyer-para'),1,8),'-',SUBSTRING(MD5('career|kariyer-para'),9,4),'-4',SUBSTRING(MD5('career|kariyer-para'),14,3),'-8',SUBSTRING(MD5('career|kariyer-para'),18,3),'-',SUBSTRING(MD5('career|kariyer-para'),21,12)),'career','Kariyer & Para Danışmanlığı','kariyer-para','İş hayatında zamanlama, fırsatlar ve finansal akış.',45,20.00,'EUR','audio',0,2,1),

  (CONCAT(SUBSTRING(MD5('dream_interpretation|free-intro'),1,8),'-',SUBSTRING(MD5('dream_interpretation|free-intro'),9,4),'-4',SUBSTRING(MD5('dream_interpretation|free-intro'),14,3),'-8',SUBSTRING(MD5('dream_interpretation|free-intro'),18,3),'-',SUBSTRING(MD5('dream_interpretation|free-intro'),21,12)),'dream_interpretation','Ücretsiz Tanışma Görüşmesi','free-intro','Ücretsiz ön görüşme.',15,0.00,'EUR','audio',1,1,1),
  (CONCAT(SUBSTRING(MD5('dream_interpretation|ruya-yorumu'),1,8),'-',SUBSTRING(MD5('dream_interpretation|ruya-yorumu'),9,4),'-4',SUBSTRING(MD5('dream_interpretation|ruya-yorumu'),14,3),'-8',SUBSTRING(MD5('dream_interpretation|ruya-yorumu'),18,3),'-',SUBSTRING(MD5('dream_interpretation|ruya-yorumu'),21,12)),'dream_interpretation','Rüya Yorumu','ruya-yorumu','Rüya sembollerinin kişisel bağlamda yorumu.',30,11.00,'EUR','audio',0,2,1),
